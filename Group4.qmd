...
@fig-Family-members. illustrates the distribution of the total number of
family members in the dataset. The distribution is right-skewed, with
the majority of households having between 3 and 6 family members. The
most common household size is 4 members, followed by households with 3
and 5 members. Very few households have more than 10 members, and
households with fewer than 3 members are also relatively rare. This
suggests that medium-sized households are the most prevalent in the
sample population, while both very small and very large families are
less common.
